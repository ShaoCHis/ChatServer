...
static void InitDefaultsscc_info_GetFriendsListRequest_test_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendsListRequest_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFriendsListRequest_test_2eproto}, {}};

static void InitDefaultsscc_info_GetFriendsListResponse_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendsListResponse_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendsListResponse_test_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendsListResponse, friendslist_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 31, -1, sizeof(::fixbug::GetFriendsListRequest)},
  { 37, -1, sizeof(::fixbug::User)},
  { 45, -1, sizeof(::fixbug::GetFriendsListResponse)},
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ug.LoginResponse\022O\n\016GetFriendsList\022\035.fix"
  "bug.GetFriendsListRequest\032\036.fixbug.GetFr"
  "iendsListResponseB\003\200\001\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[7] = {
  &scc_info_GetFriendsListRequest_test_2eproto.base,
  &scc_info_GetFriendsListResponse_test_2eproto.base,
...
const GetFriendsListRequest& GetFriendsListRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendsListRequest_test_2eproto.base);
  return *internal_default_instance();
}
...
void GetFriendsListResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendsListResponse_test_2eproto.base);
  result_ = nullptr;
}
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendsListResponse::_InternalSerialize(
  ...
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_friendslist_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_friendslist(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendsListResponse)
  ...
  for (const auto& msg : this->friendslist_) {
    total_size +=
