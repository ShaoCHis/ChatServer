...
// repeated .fixbug.User friendsList = 2;
inline int GetFriendsListResponse::_internal_friendslist_size() const {
  return friendslist_.size();
}
inline int GetFriendsListResponse::friendslist_size() const {
  return _internal_friendslist_size();
}
inline void GetFriendsListResponse::clear_friendslist() {
  friendslist_.Clear();
}
inline ::fixbug::User* GetFriendsListResponse::mutable_friendslist(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendsListResponse.friendsList)
  return friendslist_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendsListResponse::mutable_friendslist() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendsListResponse.friendsList)
  return &friendslist_;
}
inline const ::fixbug::User& GetFriendsListResponse::_internal_friendslist(int index) const {
  return friendslist_.Get(index);
}
inline const ::fixbug::User& GetFriendsListResponse::friendslist(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListResponse.friendsList)
  return _internal_friendslist(index);
}
inline ::fixbug::User* GetFriendsListResponse::_internal_add_friendslist() {
  return friendslist_.Add();
}
inline ::fixbug::User* GetFriendsListResponse::add_friendslist() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendsListResponse.friendsList)
  return _internal_add_friendslist();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendsListResponse::friendslist() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendsListResponse.friendsList)
  return friendslist_;
}
